...
#           Vous ne pouvez modifier que la méthode step(.) de la classe AgentTypeA -- toute autre modification est exclue.
#           Les vitesses de translation et rotation maximales sont données par maxTranslationSpeed et maxRotationSpeed. Interdit d'aller plus vite!
#           La distance maximale autorisée des senseurs est maxSensorDistance
#           Liste *exhaustive* des informations que vous pouvez utiliser:
#               sur soi-même:
...
#
#       Remarques:
#           La méthode step() de multirobots.py illustre les senseurs autorisés
#           Lors de l'évaluation, les numéros de vos robots peuvent être différents.
#           Par exemple: le groupe no.1 contient les robots 0,1,2,3, et le groupe no.2 robots contient les robots 4,5,6,7. A partir de son propre numéro, il est donc possible de savoir si un autre robot appartient à son propre groupe.
#
#       Recommandations:
